...
\paper
  ...
  {A multi-session counseling agent combining client-specific skill selection and cross-client response-policy learning over a frozen base LLM.}
  {
    ...
    \item Current manuscript: PsychEval Overall 7.675; reported PsychAgent-32B reference 7.348.
    \item MusPsy working-alliance mean: 4.5850; protocol-matched ranking against references is not yet established.
  }
