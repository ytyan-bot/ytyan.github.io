    ...
    publications: [
      ...
      },
      {
        ...
        highlights: [
          ...
          'SOTA on three benchmarks: PsychEval Overall 7.675; MusPsy mean working alliance 4.5850; SummEval mean Spearman correlation 0.508 (SOCA)',
        ],
      },
    ],
    education: [
    ...
    publications: [
      ...
      },
      {
        ...
        highlights: [
          ...
          '三个 benchmark 均达到 SOTA：PsychEval 综合均分 7.675；MusPsy 工作同盟均分 4.5850；SummEval 平均 Spearman 相关系数 0.508（SOCA）',
        ],
      },
    ],
    education: [
